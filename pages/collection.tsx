...
export default function Home({ levers }: { levers: Lever[] }) {
  ...
  const handleClick = (lever: Lever) => {
    ...
    router.replace(
      {
        pathname: '/collection',
        query: { lever: encodeURIComponent(lever.title) },
      },
      undefined,
      { shallow: true }
    );
    ...
    <div className=''>
      ...
      <div className='flex flex-row border-b-[1px] border-black max-h-[96.5vh]'>
          ...
          <div className='inline w-full h-30 md:h-full flex flex-col md:flex-row '>
            <div className='md:w-[15vw] md:border-r-[1px] border-b-[1px] md:border-b-[0px] border-black p-8 flex flex-row md:flex-col gap-x-4 '>
              ...
              <div className='pt-10 text-gray-500'>
                <p className=' text-xs '>
                  Anyone can contribute new levers* or edits to existing ones
                  through our public{' '}
                  <a
                ...
                <p className='text-gray-500 md:mt-6 text-xs'>
                  *LoP is not meant to be an exhaustive list of levers, nor the
                  authoriative source on a particular concept. Rather, it merely
                  serves as an introduction to these ideas and are meant to
                  spark conversations. The inclusion of a lever does not
                  necessarily constitute an endorsement of it or reflect the
                  work of our contributors.
                </p>
              </div>
            </div>
                      ...
                      >
                        <div className='flex flex-row justify-between md:justify-between content-start items-start w-full gap-2 '>
                          <div className='max-w-3/4 md:max-w-[70%] overflow-auto'>
                            <h2 className='text-[30px] whitespace-normal leading-8'>
                              {lever?.title}
                            </h2>
        ...
        <div className='w-5/12 hidden md:inline-block overflow-y-scroll'>
          ...
          <div className='p-8'>
            <h2 className='mt-3 my-2 leading-10'>{selectedLever?.title} </h2>
