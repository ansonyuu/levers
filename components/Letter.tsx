...
export default function Letter() {
  return (
    <div className='w-full flex flex-col justify-center items-center '>
      ...
      <div>
        <figure className='image'>
          <a
            target='_blank'
            rel='noopener noreferrer'
            href='https://lh4.googleusercontent.com/Fcy0wtq-4mfH2HjLuWFb_qbX0rHCmjtiPYHQrY6pf8dqw71XMYFvVPhEVvw9NrnJFg8SBEtaPRA2sABNSRpVMjPq8fNDyD39i9TMEI6nfNAzyJRiiD_OvLvkSGaD7YUh_UN3QaarkEApqFdFVTZClcE'
          >
      ...
      <div>
        <figure className='image'>
          <a
            target='_blank'
            rel='noopener noreferrer'
            href='https://lh3.googleusercontent.com/QTAf9K-C3ISrXteKUNaWcbR4iAD10rerzMg6A3gRdR346DqT0yV8z7AcLwOeO2R6j3I5iV8pWEiKPQQTXk_UmzEy73nSFnSbBZtYyY6Mqk0BvkA2S_iPx4L87s90R2Xky7mqSjXHlrApxPk2ynzr1MY'
          >
      ...
      <Text>
        <p className=''>
          Cultural narratives about technology took a darker turn in the late
          1960s and 70s. Left-wing humanists{' '}
          <a
            target='_blank'
            rel='noopener noreferrer'
            href='https://www.bostonreview.net/articles/andrew-jewett-science-under-fire/#:~:text=increasingly%20argued%20that%20science%E2%80%99s%20cultural%20influence%20buttressed%20social%20inequalities%2C%20keeping%20favored%20groups%20in%20power%20and%20others%20down'
          >
            argued
          </a>{' '}
      ...
      <div>
        <figure className='image'>
          <a
            target='_blank'
            rel='noopener noreferrer'
            href='https://lh3.googleusercontent.com/7JxkbdnuMFfRZejWavLfATZu_F7Qdw-kY0R4fp_sDHE5pqdmmUABusJ8xHqVl-67WF0y0siTc7CJnT12M_Ruwn-UB787OFg1Zo9NncOQVAv1-Gjf2Po6CCY5-BV5YzQMtll67i_auMIVxaMW40jx4C8'
          >
        ...
        <p className=''>
          ...
          <Sidenote right={false}>
            ...
            <a
              target='_blank'
              rel='noopener noreferrer'
              href='https://www.census.gov/foreign-trade/reference/codes/atp/index.html'
            >
              US Census Bureau
            </a>
            . )
      ...
      <div className='flex flex-row gap-x-3'>
        <figure className='image'>
          <a
            target='_blank'
            rel='noopener noreferrer'
            href='https://lh6.googleusercontent.com/AU2j0PEiBS4Sii7tiZ_0L889P0Yjb3ezg3XEHwBArgcofA3l8rOJg6tvMChI37pUGNwUej62dlHDrT863_eki3WPOw8PDGOXHCjv5NlXyPNcxVb2GvNR0muC-WKxmwWMeD7N-FFEttZoCClDStUjLIA'
          >
        ...
        <figure className='image'>
          <a
            target='_blank'
            rel='noopener noreferrer'
            href='https://lh4.googleusercontent.com/W6d5hkYA6gIfay8cwdlkP8_ZNhB6VLJa7XaTVC3ALbIFwODcHqXCAI1qaMtl3gqbgcztwGflZqh602IGue2joE2DFEQjDF6owjjtlKrneZhCFTlZ3ECHx_hMpzrFzL30HcDbW9cPUREG2s5PLN6VtOs'
          >
      ...
      <div>
        <figure className='image'>
          <a
            target='_blank'
            rel='noopener noreferrer'
            href='https://lh3.googleusercontent.com/1RXsdyvYPgOV1-sKsfde7f9UjZg_s0pi5OSFdJ7y3yeektJa4SonIPbSW-MFes5Zh_5eODz7WbEj-d28so6at8D88fNYaZjcwT8YflW47S7V1eIvP3SGlWlzfl6yT1ed_NCf8kkKTcIx9DnpEawC3v0'
          >
      ...
      <Text>
        <p className=''>
          Of course, material innovation is not necessarily the best or only way
          to solve these problems. The highest-impact levers to reduce housing
          costs require zero science or technology, such as updating{' '}
          <a
            target='_blank'
            rel='noopener noreferrer'
